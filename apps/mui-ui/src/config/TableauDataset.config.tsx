...
const gridHeaders: GridColumnHeader[] = [
  ...
  {
    name: 'sourceSpecificMetadata.TableauDataset.external_url',
    label: 'External URL',
    width: '33%',
  },
];
...
const attributesMap: Attribute[] = [
  ...
  {
    name: 'sourceSpecificMetadata.TableauDataset.last_ingested',
    label: 'Last Ingested',
    showInColumn: 2,
...
export const TableauDatasetConfig: DataSource = {
  id: '10',
  name: 'TableauDataset',
  showColumns: true,
